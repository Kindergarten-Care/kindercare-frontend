...
export const KpiCard = styled.div<{ $borderColor?: string }>`
  ...
  border: 1px solid ${props => props.$borderColor || '#E6EEE9'};
...
export const KpiIconBlock = styled.div<{ $bg: string; $color: string }>`
  flex: none;
  width: 48px;
  height: 48px;
  border-radius: 14px;
...
export const WeeklyTrendTitle = styled.div`
  font-size: 14.5px;
  font-weight: 700;
  color: #374151;
`;

export const WeeklyTrendSubtitle = styled.div`
  font-size: 12px;
  font-weight: 600;
  color: #9CA3AF;
`;
...
export const CalendarCard = styled.aside`
  background: #fff;
  border-radius: 20px;
  border: 1px solid #E6EEE9;
  padding: 24px;
...
export const CalendarDowLabel = styled.div`
  font-size: 11.5px;
  font-weight: 700;
  color: #9CA3AF;
  text-align: center;
...
export const CalendarDayCell = styled.div<{ $isToday?: boolean; $isFuture?: boolean; $weekend?: boolean }>`
  ...
  color: ${props => {
    ...
    if (props.$weekend) return '#9CA3AF';
    return '#374151';
  }};
  background: ${props => props.$isToday ? '#005A36' : 'transparent'};
  border-radius: 10px;
  position: relative;
  cursor: ${props => props.$isFuture ? 'default' : 'pointer'};

  &:hover {
    background: ${props => props.$isToday ? '#005A36' : (props.$isFuture ? 'transparent' : '#F3F6F4')};
  }
`;
