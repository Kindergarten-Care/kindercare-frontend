...
"[project]/apps/admin/src/i18n/request.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$i18n$2f$routing$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/admin/src/i18n/routing.ts [middleware] (ecmascript)");
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$server$2f$react$2d$server$2f$getRequestConfig$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__default__as__getRequestConfig$3e$__["getRequestConfig"])(async ({ requestLocale })=>{
    ...
    if (!locale || !__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$i18n$2f$routing$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["routing"].locales.includes(locale)) {
        locale = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$i18n$2f$routing$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["routing"].defaultLocale;
    }
    return {
        locale,
        messages: (await __turbopack_context__.f({
            "../resources/locales/en.json": {
                id: ()=>"[project]/apps/admin/src/resources/locales/en.json.[json].cjs [middleware] (ecmascript, async loader)",
                module: ()=>__turbopack_context__.A("[project]/apps/admin/src/resources/locales/en.json.[json].cjs [middleware] (ecmascript, async loader)")
            },
            "../resources/locales/vi.json": {
                id: ()=>"[project]/apps/admin/src/resources/locales/vi.json.[json].cjs [middleware] (ecmascript, async loader)",
                module: ()=>__turbopack_context__.A("[project]/apps/admin/src/resources/locales/vi.json.[json].cjs [middleware] (ecmascript, async loader)")
            }
        }).import(`../resources/locales/${locale}.json`)).default
    };
});
}),
"[project]/apps/admin/src/i18n/routing.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/admin/src/proxy.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$middleware$2f$middleware$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$i18n$2f$routing$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["routing"]);
const config = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0gl-0_l._.js.map