...
export const SERVER = {
  ...
  teacher: {
    ...
    uploadAttendancePhoto:   '/teacher/attendance/upload-photo',
    postAttendanceQuick:     '/teacher/attendance/quick',
    postAttendanceMeals:     '/teacher/attendance/meals',
    postAttendanceActivities:'/teacher/attendance/activities',
    ...
    getWeeklySchedule:       '/teacher/classes/:classId/schedule/weekly',
    getMenu:                 '/teacher/classes/:classId/menu',
    getWeeklyMenu:           '/teacher/classes/:classId/menu/weekly',
    getMedicalRequests:      '/teacher/classes/:classId/medical-requests',
    updateMedicalRequest:    '/teacher/medical-requests/:requestId',
    ...
    readAllNotifications:    '/teacher/notifications/read-all',
    ...
    deleteNewsfeed:          '/teacher/newsfeeds/:postId',
    uploadPhoto:             '/teacher/upload',
