...
export const SERVER = {
  ...
  teacher: {
    ...
    listAllergies:           '/teacher/classes/:classId/student-health/allergies/:studentId',
    createAllergy:           '/teacher/classes/:classId/student-health/allergies/:studentId',
    updateAllergy:           '/teacher/classes/:classId/student-health/allergies/item/:allergyId',
    deleteAllergy:           '/teacher/classes/:classId/student-health/allergies/item/:allergyId',
    listMedications:         '/teacher/classes/:classId/student-health/medications/:studentId',
    createMedication:        '/teacher/classes/:classId/student-health/medications/:studentId',
    updateMedicationStatus:  '/teacher/classes/:classId/student-health/medications/item/:medicationId/status',
    deleteMedication:        '/teacher/classes/:classId/student-health/medications/item/:medicationId',
    listHealthLogs:          '/teacher/classes/:classId/student-health/logs/:studentId',
    createHealthLog:         '/teacher/classes/:classId/student-health/logs/:studentId',
    updateHealthLog:         '/teacher/classes/:classId/student-health/logs/item/:logId',
    deleteHealthLog:         '/teacher/classes/:classId/student-health/logs/item/:logId',
  },
  notifications: {
